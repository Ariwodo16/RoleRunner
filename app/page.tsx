...
export default function Home() {
  ...
  const faqItems = [
    { question: 'Do you need my login credentials?', answer: 'No. We never ask for your passwords. We apply using your provided materials (resume, cover letter, etc.) and information. For platforms that require manual submission, we use your contact info to complete applications on your behalf.' },
    ...
    { question: 'What information do you need from me?', answer: 'We need your resume, target job titles, location preferences, salary requirements, and any must-haves (e.g., remote only, specific industries). Optional: LinkedIn URL, portfolio, cover letter templates, and platform preferences.' },
    { question: 'Can I pause my subscription anytime?', answer: 'Yes. You can pause or cancel at any time with no penalties. If you get an offer or want to pause while interviewing, just let us know and we\'ll stop applications immediately.' },
      ...
      <section id="packages" className="py-20 px-4 bg-gradient-to-br from-sand-50 to-sunset-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <PricingCard name="Starter Sprint" price="$299" description="Perfect for testing the waters" features={['15-20 applications per week','Criteria filtering & matching','Application tracking sheet','Weekly status updates','Email support','Pause anytime']} ctaText="Start Sprint"/>
            <PricingCard name="Fast Lane" price="$499" description="Most popular for active searchers" features={['20-30 applications per week','Light resume tailoring','Cover letter templates','Priority sourcing','Advanced tracking dashboard','Slack/email support','Weekly optimization calls']} isPopular badge="MOST POPULAR" ctaText="Enter Fast Lane"/>
            <PricingCard name="Premium Relay" price="Custom" description="Full-service execution" features={['Custom application volume','Recruiter outreach included','Keyword alignment reports','Company research briefs','Interview prep support','Dedicated account manager','Custom integrations']} ctaText="Book Consult" ctaHref="/contact"/>
          </div>
      ...
      <section id="results" className="py-20 px-4 bg-gradient-to-br from-sky-50 to-sand-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[{num:'25',label:'Avg. weekly applications',color:'from-sunset-500 to-sunset-600'},{num:'Weekly',label:'Detailed reporting',color:'from-sky-500 to-sky-600'},{num:'100%',label:'Quality checkpoints',color:'from-sand-500 to-sand-600'}].map((stat,i)=>(
